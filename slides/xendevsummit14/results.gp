#!/usr/local/Cellar/gnuplot/4.6.5/bin/gnuplot
#
#    
#    	G N U P L O T
...
set xlabel "Number of parallel VM start/shutdown/destroy sequences" 
...
GNUTERM = "wxt"
plot 'results.dat' using 1:2 title 'C xenstored' with linespoints, 'results.dat' using 1:3 title 'oxenstored' with linespoints, 'results.dat' using 1:4 title 'irmin xenstored' with linespoints
#    EOF
