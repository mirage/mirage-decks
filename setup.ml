...
(* OASIS_START *)
(* DO NOT EDIT (digest: 60fbe1314a1f1e628216ab2174d0edaf) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cohttp.mirage-unix", None);
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "o\016í'PÀ\017°Gîå§Z\0174k";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
